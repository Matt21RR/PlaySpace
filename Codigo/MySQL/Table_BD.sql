...
INSERT INTO EVENTOS (ID_USUARIO,
                    ...
                    FECHA_INICIO,
                    FECHA_FIN,
                    CHAT) VALUES (4,41,2,6,5,"vb",2.56685535034676,-72.6479,'2021-07-07 07:47','2021-07-09 10:47',0);
...
INSERT INTO EVENTOS (ID_USUARIO,
                    ...
                    FECHA_INICIO,
                    FECHA_FIN,
                    CHAT) VALUES (5,51,1,6,5,"jsaisnooiasnx",2.56685535034676,-72.6479,'2021-07-07 07:47','2021-07-09 10:47',0);

INSERT INTO	PARTICIPANTES_EVENTO (ID_EVENTO,
								  ID_PARTICIPANTE) VALUES (41,1);
INSERT INTO	PARTICIPANTES_EVENTO (ID_EVENTO,
								  ID_PARTICIPANTE) VALUES (41,2);
INSERT INTO	PARTICIPANTES_EVENTO (ID_EVENTO,
...
#DROP VIEW INFO_SOLICITUDES;
#SELECT * FROM INFO_SOLICITUDES;
...
#DROP VIEW INFO_SOLICITUDES_RECHAZADAS;
#SELECT * FROM INFO_SOLICITUDES_RECHAZADAS;
...
#DROP FUNCTION CANTIDAD_USUARIOS();
...
#DROP FUNCTION CANTIDAD_PEDIDOS_VALIDACION;
#SELECT CANTIDAD_PEDIDOS_VALIDACION();
#=======================================================
DELIMITER //
...
#==========================================================
DELIMITER //
#usuario_lat cordenada de latitud del usuario en grados
#usuario_lon cordenada de longitud del usuario en grados
#dist	distancia en metros para la distancia maxima entre la ubi del usuario y las ubis de los eventos
...
#CALL SP_BUSQUEDA_EVENTO(RADIANS(2.558492),RADIANS(-72.632698),1000);
#=======================================================
DELIMITER //
#usuario_lat cordenada de latitud del usuario en grados
#usuario_lon cordenada de longitud del usuario en grados
...
CREATE PROCEDURE SP_BUSQUEDA_TIENDA(usuario_lat DOUBLE, usuario_lon DOUBLE, dist INT)
	...
	END //
DELIMITER ;
#DROP PROCEDURE SP_BUSQUEDA_TIENDA;
#CALL SP_BUSQUEDA_TIENDA(RADIANS(2.558492),RADIANS(-72.632698),1000);
