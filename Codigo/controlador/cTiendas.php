<?php
    ...
    class cTiendas extends mTiendas{
         ...
         *                      [5] = Dirección tienda
         */
        static function consultarInfoTienda($ID_TIENDA){
            $info_Tienda = self::pedirInformacionTienda($ID_TIENDA);
            return $info_Tienda;
        }
        /**
        ...
        /**
         * Consultar la lista de tipos de productos que se venden en la tienda
         * @param   entero  ID_TIENDA
         * @return  arreglo lista de los tipos de productos que vende la tienda
         */
        static function consultarTipoProductos($ID_TIENDA){
            $tiposProductos = self::pedirInfoTipoProducto($ID_TIENDA); 
            $tiposProductos = array_unique($tiposProductos); //Eliminar los tipos de productos duplicados
            sort($tiposProductos);//Eliminación de los espacios vacios provocados por array_unique
