...
include_once ("../modelo/mAmigosClaveEncriptacion.php");
    class cClaveEncriptacion extends cCifradoContrasena{
         ...
         */
        static function encriptarClave($texto,$contrasena){ // ? Automatico
         ...
         */
        static function desencriptarClave($texto, $contrasena){ // ? Automatico
            include_once ("cAmigosMensajes.php");
         ...
         */
        static function crearClaveEncriptado(){// ? automatico
         ...
         */
        static function enviarClaveEncriptacion($id_chat){// TODO: PRINCIPAL
         ...
         */
        static function enviarClaveEncriptacionEncriptada($id_chat,$id_usuario, $claveEncriptacion){// ? Automatico
            $ids_array = explode("_",$id_chat);
         ...
         */
        static function recibirClaveEncriptacion($id_chat,$id_usuario,$contrasena){// TODO: PRINCIPAL
            $repetir = true;
            while ($repetir == true){//MIENTRAS LA CLAVE RECIBIDA NO ESTE ENCRIPTADA...
                ...
                if ($clave != null){//si la clave obtenida no esta vacia
                    $repetir = false;
                    if(($clave[0] == $clave[1]) && ($clave[1] == $clave[2]) && $clave[3]==" "){//DISTINTIVO DE UNA CLAVE NO ENCRIPTADA
                        echo "<script>console.warn('cClaveEncriptacion::recibirClaveEncriptacion->La clave debe de ser encriptada y reenviada')</script>";
                ...
                else{//si esta vacia crear una nueva
         ...
         * @param   texto   Id del chat (union de los id de ambos usuarios).
         */
        static function pedirCopiaClaveEncriptacion($id_usuario,$id_chat){// TODO: PRINCIPAL
            $ids_array = explode("_",$id_chat);
            //DONDE GUARDAR LA CLAVE ENCRIPTADA
            if($ids_array[0] == $id_usuario){
                $borrar_en = 0;
         ...
         */
        static function verificarClaveAmigo($id_usuario,$id_chat){// ? Automatico
            $ids_array = explode("_",$id_chat);
