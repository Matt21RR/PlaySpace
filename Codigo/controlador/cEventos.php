...
class cEventos{
    ...
    static function eliminarEvento($ID_USUARIO,$ID_EVENTO){
        $resultado = mEventos::borrarEvento($ID_USUARIO,$ID_EVENTO);
        echo "<script>console.warn('cEventos::eliminarEvento ->".$resultado."')</script>";
        return $resultado;
    }
}