...
<!-- PRODUCTOS -->
        ...
        <div>
            <?php
                if(!isset($_SESSION['INFO_PRODUCTOS'])){
                    $_SESSION['INFO_PRODUCTOS'] = cTiendas::consultarInfoProductos($_SESSION['INFO_TIENDA_SELECCIONADA'][6]);
                    $_SESSION['COPIA_SEGURIDAD_INFO_PRODUCTOS'] = $_SESSION['INFO_PRODUCTOS'];
                }
                for($i=0; $i<count($_SESSION['INFO_PRODUCTOS']); $i++){
                    echo '  <div>
                                <img src="'.$_SESSION['INFO_PRODUCTOS'][$i][2].'" width="100px" alt="No se encontro una imagen">
    ...
    <a href="pTiendaEditarProducto_productosCreados.php">Editar Productos</a>
<!-- LINEA DIVISORA -->
    <hr>
