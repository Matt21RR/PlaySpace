...
<body>
    ...
    <div class="container">
        <div class="container-fluid position-sticky mainListHeader">
            <div class="headerList">Eventos</div>
        </div>
        ...
        <?php
            ...
            $info_eventos = cEventos::consultarEventosInscritos($_SESSION['ID_USUARIO']);
        	...
        	if($cantEv != 0){
                for($posX = 0; $posX != $cantEv; $posX++){
                    ...
                    $ruta = "../controladorVista/cvListaEventosInscritos.php?";
                    echo"<br>";
                    echo"    <a href='".$ruta."ID_EVENTO=".$info_eventos[$posX][0]."' style='white-space: nowrap;'>";
                    echo"        <div class='element mx-3' style='".$style."'s>";
                ...
                echo "<br>";
                echo "<div class='container'>Al parecer no te has inscrito a ningun evento :/ </div>";
            }
        ?>
