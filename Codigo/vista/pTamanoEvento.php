      ...
      <form action="../controladorVista/cvEventoCrear.php" method="get"> <!--FORM-->
        <div class="row g-0">
          <div class="col-sm-8">
            <div class="row" style = "padding: 10px;">
              ...
              include_once ("./lists/tamanos.php");
                ...
                $colSelect = 0;
                $cantOp = 3;
                $textOp = $tamanos;//traer la lista de tamaños desde el archivo de tamaños
                
                for($Op = 1; $Op != ($cantOp+1); $Op++){
                  echo  "<div class='col-4'>";
                  echo    "<div class='btn btn-primary boxOption' id='Op".$Op."' style='background-color:".$colors[$colSelect].";' onclick='selectRadioHint(1,".$Op.",".$cantOp.")'>";
                  echo      "<label for='".$Op."'>";
                  echo        $textOp[$Op-1];
                  echo      "</label>";
          ...
          <div class="col-sm-4" style="">
            <div class="row g-0">
              <?php
                $hintText = $hintTamanos;
                for($hint = 1; $hint != ($cantOp+1); $hint++){
                  echo "<p id='textoAyuda".$hint."' class=hintText>".$hintText[$hint-1]."</p>";
                }
              ?>
            </div>
          </div>
