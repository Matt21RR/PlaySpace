function elminarProducto(ID_PRODUCTO){
    document.getElementById("_"+ID_PRODUCTO).style.display = 'none';
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("GET", "../controladorVista/cvTiendaCrearProducto_EditarEliminar.php?ID_PRODUCTO="+ID_PRODUCTO,true);
    xmlhttp.send();
}

function elminarProductoEditar(ID_PRODUCTO){
    document.getElementById("_"+ID_PRODUCTO).style.display = 'none';
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("GET", "../controladorVista/cvTiendaEditarProducto_EditarEliminar.php?ID_PRODUCTO="+ID_PRODUCTO,true);
    xmlhttp.send();
}
// /**
