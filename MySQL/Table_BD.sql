...
INSERT INTO EVENTOS (ID_USUARIO,
                    ...
                    FECHA_INICIO,
                    FECHA_FIN,
                    CHAT) VALUES (4,41,2,6,5,"vb",2.572685535034676,-72.6479,'2021-07-02 07:47','2021-06-02 10:47',0);
...
SELECT T1.ID_EVENTO, T1.TIPO_EVENTO, COUNT(T2.ID_PARTICIPANTE) AS CANTIDAD_INSCRITOS,T1.CANTIDAD_PARTICIPANTES,T1.FECHA_INICIO,T1.TAMANO_EVENTO
